   ...
   каждого текстовая и заливочная ступень — итого не больше 8 цветных. */
{
  ...
  // 4 оттенка × (заливка + чернила для текста) + наведение на действие = 9 (светлая тема, 05.09.2026)
  if (chromatic.length > 9) fails.push(`хроматических ${chromatic.length} — больше 9: четыре акцента по две ступени плюс наведение`);
}
